    ...
    <div className=" flex items-center justify-between px-8 md:px-20 lg:px-32 py-3 lg:py-5 shadow-md shadow-slate-200  sticky top-0 z-20 bg-white ">
      ...
      <div className="hidden md:block">
        <ul className="flex gap-8 ">
          <li className=" lg:text-base xl:text-lg font-semibold  flex items-center gap-2 cursor-pointer">
          ...
          {/** Login/Logout Button
            ...
            <button
            onClick={toggleBtn}
            className=" lg:text-base xl:text-lg font-semibold  w-24 flex justify-center items-center gap-2 cursor-pointer "
            >
            {btn === "Login" ? (
